...
class SelectionFragment : Fragment(), View.OnClickListener {
    ...
    fun navigateWithIndex(index : Int) {
        ...
        val bundle = bundleOf("index" to index) //키 값 index

        navController.navigate(R.id.action_selectionFragment_to_resultFragment,bundle) //data를 bundle에 담아 보냄
